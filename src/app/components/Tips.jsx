      ...
      <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
        <div className="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
          ...
          <p className="mt-6 text-base/7 text-pink-900">
            Usando minhas redes sociais para promover a conscientização e a
            educação sobre a importância da nutrição no manejo de dislipidemia,
            sarcopenia e depressão, com foco em intervenções Nutricionais e
            hábitos alimentares.
          </p>
          <div className="mt-8">
            <a
