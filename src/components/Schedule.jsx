        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 sm:gap-x-6">
            ...
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="group flex items-center justify-center text-lg font-bold text-white px-6 py-5 rounded-xl border-2 border-white/30 hover:border-white hover:bg-white/15 backdrop-blur-sm transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
              <CiInstagram className="mr-3 h-6 w-6 group-hover:scale-110 transition-transform" aria-hidden="true" />
